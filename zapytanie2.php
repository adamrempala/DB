...
<HEAD>
    <TITLE> Query II </TITLE>
</HEAD>

<BODY>
<h2> How popular was given hashtag during phases of a day in the given period? </h2>
...
if (!$conn) {
    ...
    $a = transliterateString($_POST['HSTG']);
    ...
    sendOracle($conn, "BEGIN zapytanie_2('$a', '$b', '$c'); END;", "Query failed");
