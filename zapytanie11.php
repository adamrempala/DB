...
<HEAD>
    <TITLE> Query XI </TITLE>
</HEAD>

<BODY>
<h2> How many users from given location writing during given period have descriptions? What is their average length? </h2>
...
if (!$conn) {
    ...
    echo 'Results for data:<br>Location: '.$a.'<br>From: '.$b.'<br>To: '.$c.'<br><br>';
    
    SetServerOutput($conn, true);
    
    sendOracle($conn, "BEGIN zapytanie_11('$a', '$b', '$c'); END;", "Query failed");
