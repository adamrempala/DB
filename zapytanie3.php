...
<HEAD>
    <TITLE> Query III </TITLE>
</HEAD>

<BODY>
<h2> How big is average number of retweets, favourites, hashtags and mentions for Tweets created at period by people registrated in another period? </h2>
...
$_SESSION['REGIFROM'] = $_POST['RGFM'];
$_SESSION['REGITO'] = $_POST['RGTO'];
$_SESSION['TWEETFROM'] = $_POST['TWFM'];
$_SESSION['TWEETTO'] = $_POST['TWTO'];
///////////////////////////////////
...
if (!$conn) {
    ...
    $a = transliterateString($_POST['RGFM']);
    $a1 = transliterateString($_POST['RGTO']);
    $b = transliterateString($_POST['TWFM']);
    $c = transliterateString($_POST['TWTO']);
    
    echo 'Results for data:<br>Registration from: '.$a.'<br>Registration to: '.$a1.'<br>Tweet from: '.$b.'<br>Tweet to: '.$c.'<br><br>';
    
    SetServerOutput($conn, true);
    
    sendOracle($conn, "BEGIN zapytanie_3('$a', '$a1', '$b', '$c'); END;", "Query failed");
