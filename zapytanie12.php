...
<HEAD>
    <TITLE> Query XII </TITLE>
</HEAD>

<BODY>
<h2> Which words appear most often in usernames writing in a given period? </h2>
...
if (!$conn) {
    ...
    sendOracle($conn, "BEGIN zapytanie_12('$b', '$c', $d); END;", "Query failed");
