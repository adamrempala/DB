...
<HEAD>
    <TITLE> Query VI </TITLE>
</HEAD>

<BODY>
<h2> Who is mentioned most often in tweets containing given phrase? </h2>
...
if (!$conn) {
    ...
    echo 'Results for data:<br>Searched phrase: '.$a.'<br>From: '.$b.'<br>To: '.$c.'<br> Number of results: '.$d.'<br><br>';
    
    SetServerOutput($conn, true);
    
    sendOracle($conn, "BEGIN zapytanie_6('$a', '$b', '$c', $d); END;", "Query failed");
