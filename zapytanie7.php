...
<HEAD>
    <TITLE> Query VII </TITLE>
</HEAD>

<BODY>
<h2> What was the most popular person mentioned and hashtag accompaning given hashtag each day from given period? </h2>
...
if (!$conn) {
    ...
    echo 'Results for data:<br>Hashtag: '.$a.'<br>From: '.$b.'<br>To: '.$c.'<br><br>';
    
    SetServerOutput($conn, true);
    
    
    sendOracle($conn, "BEGIN zapytanie_7('$a', '$b', '$c'); END;", "Query failed");
